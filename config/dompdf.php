...
return [
    ...
    */
    ...
    'options' => [
         ...
         */
        /*
         * Enabled deliberately. With subsetting off, dompdf embeds the complete
         * DejaVu font files in every document: a one-page vendor confirmation
         * letter came out at 1.1 MB and peaked at 74 MB of memory, enough to
         * exhaust the default 128 MB limit when several PDFs are produced in one
         * process (it broke the test suite). Subsetting embeds only the glyphs
         * actually used.
         */
